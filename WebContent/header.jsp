...
<%@ page import="com.grocery.service.impl.*,com.grocery.service.*"%>
...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		...
		<h6> delivery within 12 hours</h6>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="index.jsp?type=dal">Dal And Pulses</a></li>
							<li><a href="index.jsp?type=grains">Grains</a></li>
							<li><a href="index.jsp?type=oil">Oil</a></li>
							<li><a href="index.jsp?type=spices">Spices</a></li>
							<li><a href="index.jsp?type=packagedFood">Packaged Food</a></li>
							<li><a href="index.jsp?type=cleaners">Soaps And Cleaners</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="userHome.jsp?type=dal">Dal And Pulses</a></li>
							<li><a href="userHome.jsp?type=grains">Grains</a></li>
							<li><a href="userHome.jsp?type=oil">Oil</a></li>
							<li><a href="userHome.jsp?type=spices">Spices</a></li>
							<li><a href="userHome.jsp?type=packagedFood">Packaged Food</a></li>
							<li><a href="userHome.jsp?type=cleaners">Soaps And Cleaners</a></li>
						</ul></li>
					<%
					if (notf == 0) {
					%>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="adminViewProduct.jsp?type=dal">Dal And Pulses</a></li>
							<li><a href="adminViewProduct.jsp?type=grains">Grains</a></li>
							<li><a href="adminViewProduct.jsp?type=oil">Oil</a></li>
							<li><a href="adminViewProduct.jsp?type=spices">Spices</a></li>
							<li><a href="adminViewProduct.jsp?type=packagedFood">Packaged Food</a></li>
							<li><a href="adminViewProduct.jsp?type=cleaners">Soaps And Cleaners</a></li>
						</ul></li>
