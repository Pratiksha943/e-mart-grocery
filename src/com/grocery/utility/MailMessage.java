...
public class MailMessage {
	public static void registrationSuccess(String emailId, String name) {
		...
		String htmlTextMessage = "" + "<html>" + "<body>"
				+ "<h2 style='color:green;'>Welcome to  E mart Grocery</h2>" + "" + "Hi " + name + ","
				+ "<br><br>Thanks for signing up with E mart Grocery.<br>"
				+ "We are glad that you choose us. We invite you to check out our latest collection of various grocery products."
				+ "<br>We are providing upto 60% OFF on most of the grocery products. So please visit our site and explore the collections."
				+ "<br><br>Our Online Grocery shopping is growing in a larger amount these days and we are in high demand so we thanks all of you for "
				...
				+ "to enter the promo code given below.<br><br><br> PROMO CODE: " + "EMARTGROCERY500<br><br><br>"
	...
	public static void transactionSuccess(String recipientEmail, String name, String transId, double transAmount) {
		...
		String subject = "Order Placed at E mart Grocery";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with E mart Grocery!" + "      <br/><br/>"
				...
				+ "      Come Shop Again! <br/<br/> <font style=\"color:green;font-weight:bold;\">E mart Grocery</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
	...
	public static void orderShipped(String recipientEmail, String name, String transId, double transAmount) {
		String recipient = recipientEmail;
		String subject = "Hurray!!, Your Order has been Shipped from E mart Grocery";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with E mart Grocery!" + "      <br/><br/>"
	...
	public static void productAvailableNow(String recipientEmail, String name, String prodName, String prodId) {
		String recipient = recipientEmail;
		String subject = "Product " + prodName + " is Now Available at E mart Grocery";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with EE mart Grocery!" + "      <br/><br/>"
				...
				+ "      Come Shop Again! <br/<br/><br/> <font style=\"color:green;font-weight:bold;\">E mart Grocery.</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
